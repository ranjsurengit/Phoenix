...
test.describe('Create Documents', () => {
  ...
  test('User lands on the create document page', { tag: ['@createdocument', '@CreateDocumentUI'] }, async ({ Given, When, Then, createDocumentPageObj }) => { 
...
const bddFileData = [ // bdd-data-start
  {"pwTestLine":10,"pickleLine":9,"tags":["@createdocument","@CreateDocumentUI"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given User should have logged into Suite CRM application","isBg":true,"stepMatchArguments":[]},{"pwStepLine":11,"gherkinStepLine":10,"keywordType":"Context","textWithKeyword":"Given User is on the home page banner","stepMatchArguments":[]},{"pwStepLine":12,"gherkinStepLine":11,"keywordType":"Action","textWithKeyword":"When User clicks on Create Document link","stepMatchArguments":[]},{"pwStepLine":13,"gherkinStepLine":12,"keywordType":"Outcome","textWithKeyword":"Then Create Page is displayed","stepMatchArguments":[]}]},
