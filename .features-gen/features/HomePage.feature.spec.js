...
test.describe('HomePage', () => {
  ...
  test('User can see the quick actions on the top of the page', { tag: ['@homepage', '@hm3'] }, async ({ Given, When, Then, createDocumentPageObj, homePageObj }) => { 
  ...
  test('User can view page numbers when the dashlet is added to homepage', { tag: ['@homepage', '@hm1'] }, async ({ Given, When, Then, homePageObj }) => { 
  ...
  test('User can view recently viewed items', { tag: ['@homepage', '@hm2'] }, async ({ Given, When, Then, homePageObj }) => { 
    await Given('User is on the home page', null, { homePageObj }); 
  ...
  test('User deletes a dashlet from the HomePage', { tag: ['@homepage', '@hm4'] }, async ({ Given, When, Then, homePageObj }) => { 
    await Given('A dashlet is added to homepage', null, { homePageObj }); 
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":40,"pickleLine":35,"tags":["@homepage","@hm3"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Context","textWithKeyword":"Given User should have logged into Suite CRM application","isBg":true,"stepMatchArguments":[]},{"pwStepLine":41,"gherkinStepLine":36,"keywordType":"Context","textWithKeyword":"Given User is on the home page banner","stepMatchArguments":[]},{"pwStepLine":42,"gherkinStepLine":37,"keywordType":"Action","textWithKeyword":"When User hovers on quick actions","stepMatchArguments":[]},{"pwStepLine":43,"gherkinStepLine":38,"keywordType":"Outcome","textWithKeyword":"Then the quick action icon color changes to orange","stepMatchArguments":[]}]},
  ...
  {"pwTestLine":58,"pickleLine":50,"tags":["@homepage","@hm1"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Context","textWithKeyword":"Given User should have logged into Suite CRM application","isBg":true,"stepMatchArguments":[]},{"pwStepLine":59,"gherkinStepLine":51,"keywordType":"Context","textWithKeyword":"Given A dashlet is added to homepage","stepMatchArguments":[]},{"pwStepLine":60,"gherkinStepLine":52,"keywordType":"Action","textWithKeyword":"When User views the dashlet","stepMatchArguments":[]},{"pwStepLine":61,"gherkinStepLine":53,"keywordType":"Outcome","textWithKeyword":"Then Pagination of the dashlet numbers are displayed","stepMatchArguments":[]}]},
  {"pwTestLine":64,"pickleLine":56,"tags":["@homepage","@hm2"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Context","textWithKeyword":"Given User should have logged into Suite CRM application","isBg":true,"stepMatchArguments":[]},{"pwStepLine":65,"gherkinStepLine":57,"keywordType":"Context","textWithKeyword":"Given User is on the home page","stepMatchArguments":[]},{"pwStepLine":66,"gherkinStepLine":58,"keywordType":"Action","textWithKeyword":"When User hovers on recently viewed items","stepMatchArguments":[]},{"pwStepLine":67,"gherkinStepLine":59,"keywordType":"Outcome","textWithKeyword":"Then Recently viewed items are displayed","stepMatchArguments":[]}]},
  {"pwTestLine":70,"pickleLine":62,"tags":["@homepage","@hm4"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Context","textWithKeyword":"Given User should have logged into Suite CRM application","isBg":true,"stepMatchArguments":[]},{"pwStepLine":71,"gherkinStepLine":63,"keywordType":"Context","textWithKeyword":"Given A dashlet is added to homepage","stepMatchArguments":[]},{"pwStepLine":72,"gherkinStepLine":64,"keywordType":"Action","textWithKeyword":"When User tries to close the dashlet from homepage","stepMatchArguments":[]},{"pwStepLine":73,"gherkinStepLine":65,"keywordType":"Outcome","textWithKeyword":"Then User is prompted with a pop up option","stepMatchArguments":[]}]},
]; // bdd-data-end